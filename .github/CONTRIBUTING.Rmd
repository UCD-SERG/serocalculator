...
*  This project is set up to use the [Air](https://posit-dev.github.io/air/) formatter (configured via `air.toml`). If you use VS Code or Positron, install the recommended `Posit.air-vscode` extension (see `.vscode/extensions.json`) to enable format-on-save.
