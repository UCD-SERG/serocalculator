...
* Fixed the README's link to the in-development documentation, which pointed at
  `/main/` and had been dead since #504 moved development docs to `/dev/`. Also
  removed a duplicated "the" in the same sentence. (#604)
