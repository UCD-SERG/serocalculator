...
#' for one antigen:isotype pair and incidence rate
#'
...
#' containing variables `value` and `age`
#' @param lnpars longitudinal antibody
#' decay model parameters `alpha`, `y1`, and `d`
...
#' for one antigen:isotype pair and several values of incidence (`lambda`).
