...
#'
#' @param curve_params a [data.frame()] containing one or more MCMC samples of antibody decay curve parameters
    ...
    verbose = FALSE)
{
  ...
  testthat::expect_equal(nrow(curve_params), 1)
