...
# Run the simulations in parallel
set.seed(129255)
results_50_2 <- simulate_seroincidence(renew.params = TRUE, nrep = 50, n_sim = 300)

set.seed(129256)
results_100_2 <- simulate_seroincidence(renew.params = TRUE, nrep = 100, n_sim = 300)

set.seed(129257)
results_150_2 <- simulate_seroincidence(renew.params = TRUE, nrep = 150, n_sim = 300)

set.seed(129258)
results_200_2 <- simulate_seroincidence(renew.params = TRUE, nrep = 200, n_sim = 300)
