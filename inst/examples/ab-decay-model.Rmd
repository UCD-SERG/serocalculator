...
fluidRow(
  ...
  sliderInput(
    ...
    max = 2, 
    step = .1,
    value = log10(0.18432798)) |> column(width = 4),
  sliderInput(
    inputId = "mu_y", 
    label = "log10(mu_y)", 
    min = -2, 
    max = 2, 
    step = .1,
    value = log10(0.36853621)) |> column(width = 4), 
  ...
  sliderInput(
    ...
    max = 10, 
    step = .1,
    value = log10(0.0013040664)) |> column(width = 4)
)
...
fluidRow(
  ...
  sliderInput(
    ...
    max = -1, 
    step = .1,
    value = log10(0.00002192627)) |> column(width = 4))
