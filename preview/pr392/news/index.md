...
- Added interactive Shiny app
  [`curve_app()`](https://ucd-serg.github.io/serocalculator/reference/curve_app.md)
  for visualizing antigen-antibody kinetics models with real-time
  parameter sliders
  ([\#392](https://github.com/UCD-SERG/serocalculator/issues/392)).
- Added
  [`antibody_decay_curve()`](https://ucd-serg.github.io/serocalculator/reference/antibody_decay_curve.md)
  and
  [`pathogen_decay_curve()`](https://ucd-serg.github.io/serocalculator/reference/pathogen_decay_curve.md)
  functions for simulating antibody and pathogen decay over time
  ([\#392](https://github.com/UCD-SERG/serocalculator/issues/392)).
- Added
  [`plot_decay_curve()`](https://ucd-serg.github.io/serocalculator/reference/plot_decay_curve.md)
  for plotting decay functions using ggplot2
  ([\#392](https://github.com/UCD-SERG/serocalculator/issues/392)).
- Added helper functions
  [`t1f()`](https://ucd-serg.github.io/serocalculator/reference/t1f.md)
  (time to end of active infection) and
...
- Removed a spurious `and` entry from `DESCRIPTION`’s `Imports` (not a
  real CRAN package), which previously broke package installation
  ([\#392](https://github.com/UCD-SERG/serocalculator/issues/392)).
- [`antibody_decay_curve()`](https://ucd-serg.github.io/serocalculator/reference/antibody_decay_curve.md),
  [`pathogen_decay_curve()`](https://ucd-serg.github.io/serocalculator/reference/pathogen_decay_curve.md),
  [`t1f()`](https://ucd-serg.github.io/serocalculator/reference/t1f.md),
  and
  [`y1f()`](https://ucd-serg.github.io/serocalculator/reference/y1f.md)
  now validate their parameters (non-negative values, `mu_y != mu_b`)
  and raise an informative
  [`cli::cli_abort()`](https://cli.r-lib.org/reference/cli_abort.html)
  error instead of silently returning `NaN` or dividing by zero
  ([\#392](https://github.com/UCD-SERG/serocalculator/issues/392)).
- [`plot_decay_curve()`](https://ucd-serg.github.io/serocalculator/reference/plot_decay_curve.md)
  now respects its `xmax` argument instead of always plotting to
  `x = 100`
  ([\#392](https://github.com/UCD-SERG/serocalculator/issues/392)).
