...
- type:
  ...
  - `"scatter"`: calls
    [`strat_ests_scatterplot()`](https:/ucd-serg.github.io/serocalculator/preview/pr462/reference/strat_ests_scatterplot.md)
    to generate a scatterplot

  - `"bar"`: calls
    [`strat_ests_barplot()`](https:/ucd-serg.github.io/serocalculator/preview/pr462/reference/strat_ests_barplot.md)
