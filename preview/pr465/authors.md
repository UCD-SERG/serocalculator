...
Source:
[`DESCRIPTION`](https://github.com/UCD-SERG/serocalculator/blob/CRAN-fix-release-1.3.0-em/DESCRIPTION)

Teunis P, Lai K, Orwa C, Aiemjoy K, Morrison D (2025). *serocalculator:
Estimating Infection Rates from Serological Data*. R package version
1.3.0.9060, <https://ucd-serg.github.io/serocalculator/>.
    ...
    @Manual{,
      ...
      year = {2025},
      note = {R package version 1.3.0.9060},
