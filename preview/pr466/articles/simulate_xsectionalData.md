...
- 3: decrease the `stepmin` argument to
  [`est_seroincidence()`](https:/ucd-serg.github.io/serocalculator/preview/pr466/reference/est_seroincidence.md)/[`est_seroincidence_by()`](https:/ucd-serg.github.io/serocalculator/preview/pr466/reference/est_seroincidence_by.md)
