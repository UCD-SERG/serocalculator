...
summary(est2)
#> Computing cluster-robust standard errors using cluster variable.
#> # A tibble: 1 × 10
#>   est.start incidence.rate SE[,1] CI.lwr[,1] CI.upr[,1] coverage log.lik
#>       <dbl>          <dbl>  <dbl>      <dbl>      <dbl>    <dbl>   <dbl>
#> 1       0.1          0.166 0.0193      0.132      0.209     0.95   -524.
