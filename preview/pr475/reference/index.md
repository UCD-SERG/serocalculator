...
- [`as_noise_params()`](https:/ucd-serg.github.io/serocalculator/preview/pr475/reference/as_noise_params.md)
  : Load noise parameters

- [`load_noise_params()`](https:/ucd-serg.github.io/serocalculator/preview/pr475/reference/load_noise_params.md)
  : Load noise parameters
...
- [`strata()`](https:/ucd-serg.github.io/serocalculator/preview/pr475/reference/strata.md)
  :
...
- [`get_biomarker_levels()`](https:/ucd-serg.github.io/serocalculator/preview/pr475/reference/get_biomarker_levels.md)
...
- [`summary(`*`<pop_data>`*`)`](https:/ucd-serg.github.io/serocalculator/preview/pr475/reference/summary.pop_data.md)
  [`print(`*`<summary.pop_data>`*`)`](https:/ucd-serg.github.io/serocalculator/preview/pr475/reference/summary.pop_data.md)
...
- [`autoplot(`*`<seroincidence>`*`)`](https:/ucd-serg.github.io/serocalculator/preview/pr475/reference/autoplot.seroincidence.md)
...
- [`sees_pop_data_100`](https:/ucd-serg.github.io/serocalculator/preview/pr475/reference/sees_pop_data_100.md)
  : Small example cross-sectional data set

- [`sees_pop_data_pk_100`](https:/ucd-serg.github.io/serocalculator/preview/pr475/reference/sees_pop_data_pk_100.md)
  : Small example cross-sectional data set

- [`typhoid_curves_nostrat_100`](https:/ucd-serg.github.io/serocalculator/preview/pr475/reference/typhoid_curves_nostrat_100.md)
  : Small example of antibody response curve parameters for typhoid

- [`example_noise_params_sees`](https:/ucd-serg.github.io/serocalculator/preview/pr475/reference/example_noise_params_sees.md)
  : Small example of noise parameters for typhoid

- [`example_noise_params_pk`](https:/ucd-serg.github.io/serocalculator/preview/pr475/reference/example_noise_params_pk.md)
  : Small example of noise parameters for typhoid

- [`sees_typhoid_ests_strat`](https:/ucd-serg.github.io/serocalculator/preview/pr475/reference/sees_typhoid_ests_strat.md)
  :
