...
- file_path:
  ...
  path to an RDS file containing biologic and measurement noise of
  antibody decay curve parameters `y.low`, `eps`, `nu`, and `y.high`,
  stored as a [`data.frame()`](https://rdrr.io/r/base/data.frame.html)
  or
