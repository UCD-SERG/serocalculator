...
#>   est.start incidence.rate     SE CI.lwr CI.upr se_type        coverage log.lik
#>       <dbl>          <dbl>  <dbl>  <dbl>  <dbl> <chr>             <dbl>   <dbl>
#> 1       0.1          0.128 0.0105  0.109  0.150 cluster-robust     0.95  -2376.
#> # ℹ 3 more variables: iterations <int>, antigen.isos <chr>,
#> #   nlm.convergence.code <ord>
...
#> 1 Stratu… aku         294       0.1          0.106 0.0101  0.0875  0.127 cluste…
#> 2 Stratu… kgh         200       0.1          0.167 0.00954 0.150   0.187 cluste…
...
#> 
#> data:  seroincidence estimates
#> z = -6.8447, p-value = 7.664e-12
#> alternative hypothesis: true difference in incidence rates is not equal to 0
#> 95 percent confidence interval:
#>  -0.10237165 -0.05679472
#> sample estimates:
#> incidence rate 1 incidence rate 2       difference 
...
person-years (95% CI: 400.3-507), followed by Pakistan at 127.8 per 1000
person-years (95% CI: 108.7-150.2), and Nepal at 48.2 per 1000
person-years (95% CI: 39.5-58.8). Pairwise comparisons show Bangladesh
