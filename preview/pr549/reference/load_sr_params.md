...
- file_path:
  ...
  path to an RDS file containing MCMC samples of antibody seroresponse
  parameters `y0`, `y1`, `t1`, `alpha`, and `r`, stored as a
...
- antigen_isos:
  ...
  antigen isotypes used in analyses

## Value

a `curve_params` object (a
[tibble::tbl_df](https://tibble.tidyverse.org/reference/tbl_df-class.html)
