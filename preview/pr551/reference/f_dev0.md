...
- lambda:
  ...
  [`numeric()`](https://rdrr.io/r/base/numeric.html) incidence
  parameter, in events per person-year
...
a [`numeric()`](https://rdrr.io/r/base/numeric.html) negative
log-likelihood, corresponding to input `lambda`
