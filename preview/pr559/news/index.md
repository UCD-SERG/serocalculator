...
- Disabled `indentation_linter` in `.lintr.R`. lintr 3.4.0 changed its
  default to reject the package’s established 4-space function-argument
  indentation, which would flag 39 of the package’s ~105 `R/` files
