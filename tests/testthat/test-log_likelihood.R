...
test_that("multi-biomarker log_likelihood() sums the per-biomarker values", {
  ...
  # describes -- see issue #637. This test locks in that identity so a
  # future change to the underlying model (e.g. #646) doesn't silently
  # alter it without a deliberate update to this test.
