...
It is defined by a CV (coefficient of variation) as the ratio of the standard deviation to the mean for replicates. The model accounts for this baseline assay imprecision and technical variation by applying a log-normal error structure to the observed quantitative antibody responses.
