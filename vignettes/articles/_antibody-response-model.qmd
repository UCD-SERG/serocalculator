...
approach and uses "the one-sided 95%" throughout as its working
definition of that width, but does not compare 95% against other
levels -- so the choice of 95% itself is an adopted convention (it
matches how reference intervals are commonly defined in clinical
laboratory practice), not a result derived or optimized in the paper.
