...
est2 = est.incidence.by(
  ...
  antigen_isos = c("HlyE_IgG", "HlyE_IgA"),
  numCores = 2 #Allow for parallel processing to decrease run time 
  )
...
ggplot(est2df, aes(y=catchment, x=incidence.rate*1000, fill=catchment)) +
  ...
  labs(
      title= "Enteric Fever Seroincidence by Catchment",
...
## Acknowledgements
Special thanks to collaborators and participants at Aga Khan University  (Karachi, Pakistan).  
