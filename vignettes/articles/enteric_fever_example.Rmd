...
bangla_ci_lower <- round(bangla_summary$`CI.lower (Exact)` * 1000, 1)
bangla_ci_upper <- round(bangla_summary$`CI.upper (Exact)` * 1000, 1)
...
nepal_ci_lower <- round(nepal_summary$`CI.lower (Exact)` * 1000, 1)
nepal_ci_upper <- round(nepal_summary$`CI.upper (Exact)` * 1000, 1)
...
pakistan_ci_lower <- round(pakistan_summary$`CI.lower (Exact)` * 1000, 1)
pakistan_ci_upper <- round(pakistan_summary$`CI.upper (Exact)` * 1000, 1)
