...
```
We are warned that "curve_params is missing all strata variables, and will be used unstratified". Because the "curves" dataset does not include stratification variables, this warning can be ignored, as the unstratified parameters will simply give us the overall seroincidence estimate. If you wanted to specify stratification variables that exist in a longitudinal curve parameters dataset, you could specify them using the `curve_strata_varnames` argument.
