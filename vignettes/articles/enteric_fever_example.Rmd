...
devtools::install_github("ucd-serg/serocalculator",ref = "age-case-in-clean_pop_data")
...
xs_data %>% autoplot.pop_data(strata = "Country",type='density')
...
options(scipen = 999)
xs_data %>% 
  autoplot.pop_data(strata = "Country", log = TRUE,type='density')
```
...
autoplot.pop_data(object = xs_data,type = 'age-scatter',strata = 'Country')
```
