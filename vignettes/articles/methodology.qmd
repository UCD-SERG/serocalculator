...
* Let's use $\lambda_{t}$ to denote the incidence rate at time $t$.
...
::: notes
* If a participant has never been infected since birth, then $T$ is infinite.
...
{{< include_sec-latent-likelihood.qmd >}}
...
{{< include_antibody-response-model.qmd >}}

<!-- {{< includemethods-continued.qmd >}} -->
