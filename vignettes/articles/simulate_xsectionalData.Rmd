...
It's not surprising that this simulation struggled to converge; the likelihood is very flat near the top. In contrast, the first simulation had a steeper log-likelihood curve, which made it easier to maximize:
