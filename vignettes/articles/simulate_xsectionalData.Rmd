...
# Specifcy the antibody-isotype responses to simulate
antibodies = c("HlyE_IgA", "HlyE_IgG")

## CAN WE GET RID OF THIS? MAKE IT INTERNAL?
abs <-  c(1,2);

# incidence rate per oerson-year
lambda <- 0.2; 
