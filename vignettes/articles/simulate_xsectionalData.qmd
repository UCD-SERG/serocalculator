...
* 3: decrease the `stepmin` argument to `est_seroincidence()`/`estimate_scr_by()`
* 4: increase the `iterlim` argument to `est_seroincidence()`/`estimate_scr_by()`
* 5: increase the `stepmax` argument to `est_seroincidence()`/`estimate_scr_by()`
