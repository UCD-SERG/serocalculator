...
- See the [NEWS file](../../NEWS.html) for complete details
- Check the [main tutorial](serocalculator.html) for comprehensive examples using v1.4.0 syntax
- Visit the [function reference](../../reference.html) for detailed documentation
