...
If we assume the incidence rate is constant, then the probability that our individual was *last* infected $t$ days ago (i.e., $p(T=t)$) can be calculated as the probability of being infected at time $t$ (i.e., the incidence rate at time $t$, $\lambda$) times the probability of not being infected after time $t$, which turns out to be $\exp(-\lambda t)$.
