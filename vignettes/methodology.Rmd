...
Suppose we measure biomarkers $Y$ for a simple random sample of a population at a given calendar time.
...
Unfortunately, we don't observe $T$; we only observe $Y$. So things get a little more complicated.
