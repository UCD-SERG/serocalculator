...
```{r}
#| include: false
# `typhoid_curves_nostrat_100` is `load_sr_params("https://osf.io/download/rtw5k/")`
# filtered to iter %in% 1:100, so filtering it further to iter < 50 is
# identical to filtering the raw OSF object the same way --- no need to fetch
# or vendor a separate copy of rtw5k for this.
curves <-
