...
More mathematically, the incidence rate *at a given time point*, $t$, is the *derivative* (i.e., the current rate of change over time) of the cumulative count of infections per person.
