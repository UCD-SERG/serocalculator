...
curves <- tryCatch(
  ...
  error = function(e) {
    cli::cli_warn(c(
      "Unable to load longitudinal parameters from OSF for the vignette.",
      "i" = "Using packaged example data instead."
    ))
...
xs_data <- tryCatch(
  ...
  error = function(e) {
    cli::cli_warn(c(
      "Unable to load cross-sectional data from OSF for the vignette.",
      "i" = "Using packaged example data instead."
    ))
    sees_pop_data_100
  }
...
noise <- tryCatch(
  {
    url("https://osf.io/download//hqy4v/") %>%
      readRDS()
  },
  error = function(e) {
    cli::cli_warn(c(
      "Unable to load noise parameters from OSF for the vignette.",
      "i" = "Using packaged example data instead."
    ))
