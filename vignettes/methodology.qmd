...
the incidence rate is the probability of becoming infected at that time point, 
...
Suppose we measure disease antibody levels $Y$ 
for a simple cross-sectional random sample of a population. 
For a given member of the sample, 
let $T$ denote the time since they were last exposed to typhoid. 
...
If we assume the incidence rate is constant, 
then the probability that our individual was **last** infected $t$ days ago, $p(T=t)$, 
