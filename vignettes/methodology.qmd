...
Example: if $\color{red}{\text{ten}}$ people in a population of $\color{red}1000$ contract typhoid over a one month time period, then the incidence rate for that time period is $\color{red}{\text{10 new cases per 1000 persons per month}}$.
