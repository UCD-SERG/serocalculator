...
::: {.callout-note}
**[Figure placeholder — rights pending]** *Epidemiology of enteric pathogens. Source: Nature Reviews Microbiology (2024). Permission request in progress (tracked in issue #528).*
:::
::::
...
::: {.callout-note}
**[Figure placeholder — rights pending]** *Scrub typhus pathophysiology. Source: Springer book chapter. Permission request in progress (tracked in issue #528).*
:::
::::
...
::: {.callout-note}
**[Figure placeholder — rights pending]** *Global typhoid burden and the limited adoption of typhoid conjugate vaccines. Permission request in progress (tracked in issue #528).*
:::
