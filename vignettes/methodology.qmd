...
Its rate parameter is exactly the incidence rate of @def-incidence, which is what makes $T$ worth recovering.
:::
...
to find the MLE.
That algorithm also returns a numerical Hessian (@def-hessian) at the maximum, which is what @thm-mle-asymptotic-variance turns into a standard error.
